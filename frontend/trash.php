    ...
    showConfirmModal(
        ...
        function() {
            document.querySelectorAll('#tbody tr').forEach(row => {
                ...
                const urls = { students:'../backend/delete_student.php', teachers:'../backend/delete_teacher.php', announcements:'../backend/delete_announcement_ajax.php', messages:'../backend/delete_message_ajax.php' };
